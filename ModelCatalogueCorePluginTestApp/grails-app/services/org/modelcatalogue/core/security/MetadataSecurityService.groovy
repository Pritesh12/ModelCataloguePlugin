...
class MetadataSecurityService {
    ...
    public static final List MODEL_CATALOGUE_AUDIT_PLUGIN_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/change/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List ASSET_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/asset/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/asset/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/asset/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/asset/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List DATA_ELEMENTS_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataElement/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataElement/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataElement/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List DATA_CLASS_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataClass/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataClass/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataClass/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataClass/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List CATALOGUE_ELEMENT_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/catalogueElement/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/catalogueElement/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/catalogueElement/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/catalogueElement/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List DATA_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataType/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataType/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataType/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataType/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List ENUMERATED_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/enumeratedType/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/enumeratedType/*/outgoing/*",MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/enumeratedType/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/enumeratedType/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List REFERENCE_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/referenceType/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/referenceType/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/referenceType/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/referenceType/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List DATA_MODEL_POLICY_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataModelPolicy/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ]
    ...
    public static final List PRIMITIVE_TYPE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/primitiveType/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/primitiveType/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/primitiveType/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/primitiveType/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List CSV_TRANSFORMATION_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/csvTransformation/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List TAG_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/tag/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/tag/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/tag/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/tag/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List VALIDATION_RULE_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/validationRule/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/validationRule/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/validationRule/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/validationRule/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List BATCH_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/batch/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List MODEL_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/model/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/model/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/model/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/model/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List CLASSIFICATION_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/classification/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/classification/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/classification/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/classification/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List DATA_MODEL_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/dataModel/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataModel/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/dataModel/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
    ...
    public static final List MEASUREMENT_MAPPINGS = [
            ...
            ["/api/modelCatalogue/core/measurementUnit/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/measurementUnit/*/outgoing/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/measurementUnit/*/incoming/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
            ...
            ["/api/modelCatalogue/core/measurementUnit/*/mapping/*", MetadataRolesUtils.roles('ADMIN'), HttpMethod.DELETE],
